...
use crate::constants::{ED448_SECRET_KEY_LEN, KYBER1024_SECRET_KEY_LEN};
...
optional_serde_derive! {
    ...
    pub struct PrivateKeyBundle {
        pub identity_key_sig: Bytes<ED448_SECRET_KEY_LEN>,
        pub identity_key_kx: Bytes<X448_PUBLIC_KEY_LEN>,
        pub identity_key_pq: Bytes<KYBER1024_SECRET_KEY_LEN>,
        pub signed_prekey: Bytes<X448_PUBLIC_KEY_LEN>,
        pub one_time_prekeys: HashMap<u32, Bytes<X448_PUBLIC_KEY_LEN>>,
    }
